...
//------------UART_Init------------
// Initialize the UART for 230400 baud rate (assuming 80 MHz UART clock),
...
//                 switching from PC5,PC4 to PA1,PA0
  ...
  UART0_IBRD_R = 86;                    // IBRD = int(80,000,000 / (16 * 57600)) = int(86.8055556)
  UART0_FBRD_R = 52;                    // FBRD = round(0.8055556 * 64) = 45
...
// as part of Lab 11 implement this function
	...
	}else if(n<100)
	{
		String[0] = ' '; 
		String[1] = ' '; 
		String[2] = m/10+'0'; m%=10; 
		String[3] = m+'0';		
	}else if(n<1000)
	{
		String[0] = ' '; 
		String[1] = m/100+'0'; m%=100;
		String[2] = m/10+'0'; m%=10; 
		String[3] = m+'0';	
	}else if(n<10000)
	{
		String[0] = m/1000+'0'; m%=1000; 
		String[1] = m/100+'0'; m%=100; 
		String[2] = m/10+'0'; m%=10; 
		String[3] = m+'0';	
	}
...
// as part of Lab 11 implement this function
	...
	unsigned long m = n;
	String2[5] = ' '; String2[6] = 'c'; String2[7] = 'm';
	...
	}else if(n<100)
	{
		...
		String2[2] = '.'; 
		String2[2] = '0'; 
		String2[3] = m/10+'0'; m%=10;
		String2[4] = m+'0';	
	}else if(n<1000)
	{
		String2[0] = '0'; 
		String2[2] = '.'; 
		String2[2] = m/100+'0'; m%=100;
		String2[3] = m/10+'0'; m%=10;
		String2[4] = m+'0';	
	}else if(n<10000)
	{
		String2[0] = m/1000+'0'; m%=1000;
		String2[2] = '.'; 
		String2[2] = m/100+'0'; m%=100;
		String2[3] = m/10+'0'; m%=10;
		String2[4] = m+'0';	
...
void UART_OutDistance(unsigned long n){
  ...
  UART_OutString(String2);       // output using your function
}
